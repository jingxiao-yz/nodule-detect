...
from yolox_nets import get_model_from_name
from classification_utils.utils import (cvtColor, get_classes, letterbox_image,
...
class Classification(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"        : r'/home/predict/logs/classification.pth',
        "classes_path"      : r'/home/predict/model_data/class.txt',
        #--------------------------------------------------------------------#
        #   输入的图片大小
        #--------------------------------------------------------------------#
        "input_shape"       : [224, 224],
